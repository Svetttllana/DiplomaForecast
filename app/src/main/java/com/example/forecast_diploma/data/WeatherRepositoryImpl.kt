...
class WeatherRepositoryImpl @Inject constructor(
    ...
    override suspend fun getListCityWeather() {
        ...
        return withContext(Dispatchers.IO) {
            if (!weatherDAO.doesItemsEntityExists()) {
    ...
    override suspend fun saveBlackTheme() {
        return withContext(Dispatchers.IO) {
            sharedPreferencesHelper.saveBlackTheme()
        }
    }


    override suspend fun checkTeme(isCheckd: Boolean ){
        return withContext(Dispatchers.IO) {
            sharedPreferencesHelper.checkTeme(isCheckd)
        }
    }
}
